...
similarity between two strings or two files. There is just one method 
for computing similarity supported now, Text::Similarity::Overlaps, 
...
This directory contains a driver program called text_compare.pl that can 
...
L<http://www.d.umn.edu/~tpederse/text-similarity.html>
...
Last modified by:
$Id: README.pod,v 1.10 2008/04/04 17:28:35 tpederse Exp $
